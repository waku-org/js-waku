...
## [1.0.0](https://github.com/waku-org/js-waku/compare/create-v0.0.6...create-v1.0.0) (2023-02-11)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @waku/dns-discovery bumped from * to 1.0.0
    * @waku/peer-exchange bumped from * to 1.0.0
  * devDependencies
