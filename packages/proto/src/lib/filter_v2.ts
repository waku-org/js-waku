    ...
    if (_codec == null) {
      _codec = message<FilterSubscribeResponse>(
        (obj, w, opts = {}) => {
          ...
          if (obj.statusDesc != null && obj.statusDesc !== "") {
            w.uint32(90);
...
export interface MessagePushV2 {
  wakuMessage?: WakuMessage;
  pubsubTopic: string;
}

export namespace MessagePushV2 {
  let _codec: Codec<MessagePushV2>;

  export const codec = (): Codec<MessagePushV2> => {
    if (_codec == null) {
      _codec = message<MessagePushV2>(
        (obj, w, opts = {}) => {
          if (opts.lengthDelimited !== false) {
            w.fork();
          }
  ...
  export const encode = (obj: Partial<MessagePushV2>): Uint8Array => {
    return encodeMessage(obj, MessagePushV2.codec());
  };

  export const decode = (buf: Uint8Array | Uint8ArrayList): MessagePushV2 => {
    return decodeMessage(buf, MessagePushV2.codec());
  };
}
