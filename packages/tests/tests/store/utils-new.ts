...
export const TestRoutingInfo2 = createTestUtilities("store").routingInfo; // Will be overridden
export const TestDecoder2 = createTestUtilities("store").decoder; // Will be overridden
